...
const OrderForm = () => {
  ...
  const formNames = flattenArray(categories.map( category => {
        ...
        <Table.Root variant="outline">
          <Table.Header>
            <Table.Row textAlign="center">
              <Table.ColumnHeader textAlign="center" w="25%">カテゴリー</Table.ColumnHeader>
              <Table.ColumnHeader textAlign="center" w="25%">予選</Table.ColumnHeader>
              <Table.ColumnHeader textAlign="center" w="25%">準決勝</Table.ColumnHeader>
              <Table.ColumnHeader textAlign="center" w="25%">決勝</Table.ColumnHeader>
            </Table.Row>
          </Table.Header>
          <Table.Body>
              ...
              <Table.Row key={category.id}>
                ...
                {Object.keys(rules).map( round => (
                  <Table.Cell key={category + round} textAlign="center">{
                    rules[round].find( rule => rule.category_id === category.id) ? (
